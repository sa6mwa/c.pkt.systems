...
CPKT_SUS_INTEGRATION_EXPECTED_VOX_SEGMENTS="${CPKT_SUS_E2E_EXPECTED_VOX_SEGMENTS:-11}" \
CPKT_SUS_INTEGRATION_EXPECTED_VOX_HARD_CUTS="${CPKT_SUS_E2E_EXPECTED_VOX_HARD_CUTS:-0}" \
