...
CPKT_SUS_INTEGRATION_REALTIME_LENGTH_MS="${CPKT_SUS_E2E_REALTIME_LENGTH_MS:-5000}" \
CPKT_SUS_INTEGRATION_REALTIME_KEEP_MS="${CPKT_SUS_E2E_REALTIME_KEEP_MS:-500}" \
...
CPKT_SUS_INTEGRATION_EXPECTED_VOX_SEGMENTS="${CPKT_SUS_E2E_EXPECTED_VOX_SEGMENTS:-12}" \
CPKT_SUS_INTEGRATION_EXPECTED_VOX_HARD_CUTS="${CPKT_SUS_E2E_EXPECTED_VOX_HARD_CUTS:-5}" \
