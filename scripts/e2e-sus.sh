...
printf '[e2e-sus] segmented-step-ms=%s\n' "${CPKT_SUS_E2E_REALTIME_STEP_MS:-1000}"
printf '[e2e-sus] segmented-length-ms=%s\n' "${CPKT_SUS_E2E_REALTIME_LENGTH_MS:-7000}"
printf '[e2e-sus] segmented-keep-ms=%s\n' "${CPKT_SUS_E2E_REALTIME_KEEP_MS:-1500}"
...
CPKT_SUS_INTEGRATION_SEGMENTED_STEP_MS="${CPKT_SUS_E2E_REALTIME_STEP_MS:-1000}" \
CPKT_SUS_INTEGRATION_SEGMENTED_LENGTH_MS="${CPKT_SUS_E2E_REALTIME_LENGTH_MS:-7000}" \
CPKT_SUS_INTEGRATION_SEGMENTED_KEEP_MS="${CPKT_SUS_E2E_REALTIME_KEEP_MS:-1500}" \
