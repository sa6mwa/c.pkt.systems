...
CONTRACTS = {
    ...
    "HPDF_LoadPngImageFromFile2": "Loads a PNG file as a document-owned image with delayed image-data loading.",
    "HPDF_Page_GSave": "Saves the page graphics state, including its transform and paint settings; restore it with cpkt_pdf_page_g_restore().",
    "HPDF_Page_GRestore": "Restores the most recently saved page graphics state.",
    "HPDF_Page_Concat": "Concatenates an affine transform with the page's current transform; use g_save/g_restore to limit its scope.",
    "HPDF_Page_MoveTo": "Starts a new path subpath at the given page coordinates.",
    "HPDF_Page_LineTo": "Adds a straight path segment from the current point.",
    "HPDF_Page_CurveTo": "Adds a cubic Bezier segment with two control points and an end point.",
    "HPDF_Page_CurveTo2": "Adds a cubic Bezier segment whose first control point is the current point.",
    "HPDF_Page_CurveTo3": "Adds a cubic Bezier segment whose second control point is the end point.",
    "HPDF_Page_ClosePath": "Closes the current path subpath.",
    "HPDF_Page_Rectangle": "Adds a rectangle to the current path.",
    "HPDF_Page_Stroke": "Strokes the current path with the page's stroke settings.",
    "HPDF_Page_Fill": "Fills the current path with the nonzero winding rule.",
    "HPDF_Page_Eofill": "Fills the current path with the even-odd rule.",
    "HPDF_Page_Clip": "Sets a clipping path using the nonzero winding rule; call end_path afterward.",
    "HPDF_Page_Eoclip": "Sets a clipping path using the even-odd rule; call end_path afterward.",
    "HPDF_Page_EndPath": "Ends the current path without painting it; use after clip/eoclip.",
    "HPDF_Page_SetRGBFill": "Sets the page's RGB fill color; each component is in the range 0 to 1.",
    "HPDF_Page_SetRGBStroke": "Sets the page's RGB stroke color; each component is in the range 0 to 1.",
    "HPDF_Page_DrawImage": "Draws a document-owned image at the given page position and dimensions.",
    "HPDF_Page_Ellipse": "Adds an ellipse path centered at the given page coordinates.",
    "HPDF_Page_Arc": "Adds an arc path centered at the given page coordinates.",
}
