 ...
 * native client headers, C99 integer typedefs, or provider-specific TLS/GSS objects.
 */
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
typedef struct cpkt_postgres_oauth_bearer_request cpkt_postgres_oauth_bearer_request;
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
struct cpkt_postgres {
  ...
  cpkt_postgres_result *(*tx_params)(
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_result *cpkt_postgres_execute(
    cpkt_postgres_connection *connection, const char *query);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_set_chunked_rows_mode(cpkt_postgres_connection *connection, int chunk_size);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_result *cpkt_postgres_get_result(cpkt_postgres_connection *connection);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_put_copy_data(
    cpkt_postgres_connection *connection, const char *buffer, int byte_count);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_put_copy_end(cpkt_postgres_connection *connection, const char *error_message);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_get_copy_data(
    cpkt_postgres_connection *connection, char **buffer_out, int asynchronous);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_getline(cpkt_postgres_connection *connection, char *buffer, int length);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_putline(cpkt_postgres_connection *connection, const char *line);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_getline_async(
    cpkt_postgres_connection *connection, char *buffer, int buffer_size);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_put_bytes(
    cpkt_postgres_connection *connection, const char *buffer, int byte_count);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_end_copy(cpkt_postgres_connection *connection);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_set_nonblocking(cpkt_postgres_connection *connection, int enabled);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_ping_status cpkt_postgres_ping_params(
    const char *const *keywords, const char *const *values, int expand_database_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_result_status cpkt_postgres_result_status_get(const cpkt_postgres_result *result);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
char *cpkt_postgres_result_error_field(const cpkt_postgres_result *result, int field_code);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
char *cpkt_postgres_result_field_name(const cpkt_postgres_result *result, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_result_field_number(const cpkt_postgres_result *result, const char *field_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_oid cpkt_postgres_result_field_table_oid(
    const cpkt_postgres_result *result, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_result_field_table_column(const cpkt_postgres_result *result, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_result_field_format(const cpkt_postgres_result *result, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_oid cpkt_postgres_result_field_type(
    const cpkt_postgres_result *result, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_result_field_size(const cpkt_postgres_result *result, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_result_field_modifier(const cpkt_postgres_result *result, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_oid cpkt_postgres_result_oid_value(const cpkt_postgres_result *result);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
char *cpkt_postgres_result_command_tuples(cpkt_postgres_result *result);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
char *cpkt_postgres_result_value(
    const cpkt_postgres_result *result, int row_index, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_result_value_length(
    const cpkt_postgres_result *result, int row_index, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_result_value_is_null(
    const cpkt_postgres_result *result, int row_index, int field_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_result_parameter_count(const cpkt_postgres_result *result);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_oid cpkt_postgres_result_parameter_type(
    const cpkt_postgres_result *result, int parameter_index);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_result *cpkt_postgres_describe_prepared(
    cpkt_postgres_connection *connection, const char *statement_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_result *cpkt_postgres_describe_portal(
    cpkt_postgres_connection *connection, const char *portal_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_send_describe_prepared(
    cpkt_postgres_connection *connection, const char *statement_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_send_describe_portal(
    cpkt_postgres_connection *connection, const char *portal_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_result *cpkt_postgres_close_prepared(
    cpkt_postgres_connection *connection, const char *statement_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_result *cpkt_postgres_close_portal(
    cpkt_postgres_connection *connection, const char *portal_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_send_close_prepared(
    cpkt_postgres_connection *connection, const char *statement_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_send_close_portal(
    cpkt_postgres_connection *connection, const char *portal_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
size_t cpkt_postgres_escape_string_connection(
    cpkt_postgres_connection *connection, char *destination, const char *source,
    size_t source_length, int *error_out);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
char *cpkt_postgres_escape_literal(
    cpkt_postgres_connection *connection, const char *source, size_t source_length);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
char *cpkt_postgres_escape_identifier(
    cpkt_postgres_connection *connection, const char *source, size_t source_length);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
unsigned char *cpkt_postgres_escape_bytea_connection(
    cpkt_postgres_connection *connection, const unsigned char *source, size_t source_length,
    size_t *destination_length_out);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
unsigned char *cpkt_postgres_unescape_bytea(
    const unsigned char *source, size_t *destination_length_out);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
size_t cpkt_postgres_escape_string(char *destination, const char *source, size_t source_length);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
unsigned char *cpkt_postgres_escape_bytea(
    const unsigned char *source, size_t source_length, size_t *destination_length_out);
...
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_large_object_close(cpkt_postgres_connection *connection, int descriptor);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_large_object_read(
    cpkt_postgres_connection *connection, int descriptor, char *buffer, size_t byte_count);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_large_object_write(
    cpkt_postgres_connection *connection, int descriptor, const char *buffer, size_t byte_count);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_large_object_seek(
    cpkt_postgres_connection *connection, int descriptor, int offset, int whence);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_i64 cpkt_postgres_large_object_seek64(
    cpkt_postgres_connection *connection, int descriptor, cpkt_postgres_i64 offset, int whence);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_oid cpkt_postgres_large_object_create_legacy(
    cpkt_postgres_connection *connection, int mode);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_oid cpkt_postgres_large_object_create(
    cpkt_postgres_connection *connection, cpkt_postgres_oid object_oid);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_large_object_tell(cpkt_postgres_connection *connection, int descriptor);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_i64 cpkt_postgres_large_object_tell64(
    cpkt_postgres_connection *connection, int descriptor);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_large_object_truncate(
    cpkt_postgres_connection *connection, int descriptor, size_t byte_count);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_large_object_truncate64(
    cpkt_postgres_connection *connection, int descriptor, cpkt_postgres_i64 byte_count);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_large_object_unlink(
    cpkt_postgres_connection *connection, cpkt_postgres_oid object_oid);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_oid cpkt_postgres_large_object_import(
    cpkt_postgres_connection *connection, const char *file_name);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_oid cpkt_postgres_large_object_import_with_oid(
    cpkt_postgres_connection *connection, const char *file_name, cpkt_postgres_oid object_oid);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_large_object_export(
    cpkt_postgres_connection *connection, cpkt_postgres_oid object_oid, const char *file_name);

/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_library_version(void);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
int cpkt_postgres_socket_poll(
    int socket_descriptor, int wait_for_read, int wait_for_write, cpkt_postgres_i64 end_time);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
...
char *cpkt_postgres_encrypt_password_connection(
    cpkt_postgres_connection *connection, const char *password, const char *user,
    const char *algorithm);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
cpkt_postgres_result *cpkt_postgres_change_password(
    cpkt_postgres_connection *connection, const char *user, const char *password);
/** C89 PostgreSQL facade declaration. See docs/postgres-c89-facade-spec.md. */
