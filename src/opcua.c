...
static cpkt_opcua_result cpkt_read_file_bytes(const char *path,
...
static UA_ByteString cpkt_make_borrowed_byte_string(const unsigned char *data,
                                                    size_t length) {
  UA_ByteString bytes;
...
static unsigned char *cpkt_memdup_c89(const unsigned char *value,
                                      size_t length) {
  unsigned char *copy;
...
static cpkt_opcua_result cpkt_set_variant(UA_Variant *variant,
                                          const cpkt_opcua_value *value) {
...
static cpkt_opcua_result cpkt_set_variant_array(UA_Variant *variants,
...
static cpkt_opcua_result cpkt_get_variant(const UA_Variant *variant,
...
static cpkt_opcua_result
cpkt_get_variant_borrowed(const UA_Variant *variant,
                          cpkt_opcua_value *value_out) {
  UA_String *string_value;
  UA_ByteString *bytes_value;
  UA_Guid *guid_value;
...
static cpkt_opcua_result
cpkt_get_data_value(const UA_DataValue *data_value,
...
static int cpkt_parse_simple_array_index_range(const char *index_range,
                                               size_t *start_out,
                                               size_t *count_out) {
  const char *p;
  size_t start;
