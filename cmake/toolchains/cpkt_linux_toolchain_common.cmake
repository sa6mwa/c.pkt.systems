...
function(cpkt_configure_bootlin_toolchain target_id)
  ...
  foreach(_cpkt_key source status root prefix sysroot cc cxx ld ar ranlib strip nm objcopy objdump addr2line readelf target_triple libstdcxx_a libgcc_a)
  ...
  set(CMAKE_C_COMPILER_TARGET "${_cpkt_target_triple}" CACHE STRING "" FORCE)
  set(CMAKE_CXX_COMPILER_TARGET "${_cpkt_target_triple}" CACHE STRING "" FORCE)
