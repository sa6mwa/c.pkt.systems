...
file(WRITE "${_stage_root}/lib/cmake/CpktAudio/CpktAudioConfig.cmake"
  ...
  "    INTERFACE_LINK_LIBRARIES \"miniaudio::miniaudio;CURL::libcurl\"\n"
  "  )\n"
  "endif()\n"
  ...
  "    INTERFACE_INCLUDE_DIRECTORIES \"\${_cpkt_audio_prefix}/include\"\n"
  "    INTERFACE_LINK_LIBRARIES \"cpkt::miniaudio_shared;cpkt::curl_shared\"\n"
  "  )\n"
  "endif()\n"
)
...
file(WRITE "${_stage_root}/lib/cmake/CpktSus/CpktSusConfig.cmake"
  ...
  "    INTERFACE_LINK_LIBRARIES \"whisper::whisper;CURL::libcurl;OpenSSL::Crypto\"\n"
  "  )\n"
  "endif()\n"
  ...
  "    INTERFACE_INCLUDE_DIRECTORIES \"\${_cpkt_sus_prefix}/include\"\n"
  "    INTERFACE_LINK_LIBRARIES \"cpkt::whisper_shared;cpkt::curl_shared;cpkt::openssl_crypto_shared\"\n"
  "  )\n"
  "endif()\n"
)
...
file(WRITE "${_stage_root}/lib/pkgconfig/cpkt-audio.pc"
  ...
  "Version: ${CPKT_MINIAUDIO_VERSION}\n"
  "Requires.private: miniaudio libcurl\n"
